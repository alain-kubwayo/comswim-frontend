  ...
  >
    ...
    >
      <div class="flex flex-col space-y-2 text-center">
        ...
        <p class="text-md">
          Just few information about you and your child to make your child a
          world-class swimmer!
        </p>
      </div>
      <form @submit.prevent="store.handleSubmit('guardian')" class="flex flex-col max-w-md space-y-5">
        ...
        />
        <ValidationError :errors="store.errors" field="guardian_first_name" />
        <input
          type="text"
          ...
          class="flex px-3 py-2 font-medium border-2 border-black rounded-lg outline-none md:px-4 md:py-3 placeholder:font-normal"
        />
        <ValidationError :errors="store.errors" field="guardian_last_name" />
        <div>
          <div class="flex">
            <h2
              class="flex px-2 py-1 text-white uppercase bg-sky-800 rounded-t-xl"
        ...
        <div>
          ...
          <div class="border-l-8 border-sky-800">
            <div class="px-2 rounded-md bg-gray-e00">
              ...
              <p>
                Fill in the details to help us know your child's health
                condition.
              </p>
            </div>
          </div>
...
export default {
  setup() {
    ...
    return { acceptFees, certifyInformation, store };
  },
};
</script>
<style>
